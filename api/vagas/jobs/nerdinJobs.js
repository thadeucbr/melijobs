...
const nerdinSaveJobs = async () => {
  ...
  await page.goto('https://www.nerdin.com.br/vagas?CodigoCidade=0&CodigoEspecialidade=31,25&CodigoVaga=&CodigoEmpresa=0');
  const jobs = await page.evaluate(() => {
    const arrObj = []
    document.querySelectorAll('#divListaVagas .container').forEach(vaga => arrObj.push({
